...
#         parser.add_argument('--attention', action='store_true', default=False, help='use attention')
        ...
        parser.add_argument('--use_pretrain_weights', action='store_true', default=False, help='pretrain weights for gen')
        parser.add_argument('--use_pretrain_img2depth', action='store_true', default=False, help='pretrain weights for gen')
        parser.add_argument('--inp_B', type=str, default='depth', help='chooses which input for G_B. [depth | img_depth ]')
...
#         parser.add_argument('--netG', type=str, default='resnet_6blocks', help='specify generator architecture [resnet_9blocks | resnet_6blocks]')
        ...
        parser.add_argument('--norm_d', type=str, default='instance', help='instance normalization or batch normalization [instance | batch | none | group]')
...
#         parser.add_argument('--pool_size', type=int, default=50, help='the size of image buffer that stores previously generated images')
        ...
        parser.add_argument('--hole_border', type=float, default=-0.98, help='value of holes')
